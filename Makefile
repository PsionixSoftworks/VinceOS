...
NSM			= nasm -felf32
CC 			= i686-elf-gcc -c
CC_FLAGS 	= -std=gnu99 -ffreestanding -O2 -mgeneral-regs-only -mno-red-zone -Wall -Wextra -Iinclude
LINKER		= i686-elf-gcc -T
BINARY		= VinceOS.bin
BIN_FLAGS	= -ffreestanding -O2 -nostdlib -lgcc
ALL_FILES	= boot.o exception_handler.o main.o kernel.o vga.o itoa.o strlen.o gdt.o idt.o isr.o pic.o
...
kern:
	...
	$(CC) kernel/isr.c -o isr.o $(CC_FLAGS)
linker:
